          ...
          >
            ...
            <TableBody>
              {visibleRows.map((rows, index) => {
                const isItemSelected = isSelected(rows.Item);
                const labelId = `enhanced-table-checkbox-${index}`;

                return (
                  <TableRow
                    hover
                    onClick={(event) => handleClick(event, rows.Item)}
                    role="checkbox"
                  ...
                  >
                    ...
                    <TableCell align="right">{rows.price}</TableCell>
                    <TableCell align="right">{rows.quantity}</TableCell>
                    <TableCell align="right">{rows.total}</TableCell>
